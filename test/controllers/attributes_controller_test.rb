...
class AttributesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attribute" do
    assert_difference('Attribute.count') do
      post attributes_url, params: { attribute: { id: @attribute.id, title: @attribute.title } }
    end
  ...
  test "should update attribute" do
    patch attribute_url(@attribute), params: { attribute: { id: @attribute.id, title: @attribute.title } }
